...
BULK INSERT roster 
FROM 'C:\Users\toddk\ista420-project\implementation\roster.txt'
...
FROM 'C:\Users\toddk\ista420-project\implementation\batstats.txt'
WITH (	DATAFILETYPE = 'char',
		FIRSTROW = 2,
		FIELDTERMINATOR = ',',
		ROWTERMINATOR = '\n'
...
FROM 'C:\Users\toddk\ista420-project\implementation\pitchstats.txt'
WITH (	DATAFILETYPE = 'char',
		FIRSTROW = 2,
		FIELDTERMINATOR = ',',
		ROWTERMINATOR = '\n'
